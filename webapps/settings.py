...
# Formats times across app with only hour and minute (no seconds), AM/PM
...
# Gets data from the config.ini file
FREEFOOD_TITLE = CONFIG.get("FreeFood", "title") 
FREEFOOD_USERS = CONFIG.get("FreeFood", "users") 
